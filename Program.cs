...
builder.Services.AddScoped<ICommandRepo, CommandRepo>(); // using repo makes it easier to make changes to the database. implementation stays the same
builder.Services.AddAutoMapper(AppDomain.CurrentDomain.GetAssemblies()); // using automapper makes it easier to map data between dtos and models
